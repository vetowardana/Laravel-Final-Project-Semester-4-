...
class FrontController extends Controller
{
    public function index()
	{
	    ...
	    return view('halaman_peminjaman.index', compact('products'));
	}

	public function product()
	{
	    $products = Product::orderBy('created_at', 'DESC')->paginate(12);
	    return view('halaman_peminjaman.product', compact('products'));
	}
	...
	public function show($slug)
	{
	    ...
	    return view('halaman_peminjaman.show', compact('product'));
	}
	...
	public function customerSettingForm()
	{
	    ...
	    return view('halaman_peminjaman.setting', compact('customer', 'provinces'));
	}
