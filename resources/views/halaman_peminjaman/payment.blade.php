...
@section('content')
	...
	<section class="login_box_area p_120">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					@include('layouts.halaman_peminjaman.module.sidebar')
				</div>
				<div class="col-md-9">
                    <div class="row">
						<div class="col-md-12">
                    ...
                    <form action="{{ route('customer.savePayment') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="transfer_to" class="form-control" required>
                                ...
                                <option value="BCA - 1234567">BCA: 1234567 a.n Rental SP</option>
                                <option value="Mandiri - 2345678">Mandiri: 2345678 a.n Rental SP</option>
                                <option value="BRI - 9876543">BCA: 9876543 a.n Rental SP</option>
                                <option value="BNI - 6789456">BCA: 6789456 a.n Rental SP</option>
                            </select>
